  ...
  return (
    <div className="w-full max-w-sm mx-auto flex flex-col justify-center h-full">
      ...
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        {error && (
          <div className="rounded-xl border border-error/30 bg-error-container/20 p-3 text-sm text-error font-medium flex items-center gap-2">
        ...
        <Button
          type="submit"
          className="w-full font-semibold h-12 text-base transition-all mt-4"
          disabled={loading}
        >
          {loading ? (
